...
//   const accessToken= "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImhvYW5nLmRhaS50aHVjQGdtYWlsLmNvbSIsInN1YiI6IjE0OTljODYwLWUwNzQtNGY1Ny1iYWNlLTllMmYwY2UwMTUxNSIsImlhdCI6MTY1ODIxMTczMSwiZXhwIjoxNjU4Mjk4MTMxfQ.1wxgsm8aNImE-eSIXxf7VlEPxuRvbOyNw7sy6s3eDJI"

//   useEffect(() => {
//   const getListTreasure =  async() => {
//     try {
//       const res = await axios({
//         url:`https://eagon.tk/api/treasure/getByWallet?address=${addressWallet}`,
//         method: "GET",
//         headers: {
...
//     } catch (err) {
//       console.log("Get list treasure:", err);
//     }
//   };
//   },[]);
